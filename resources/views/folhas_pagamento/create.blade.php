    ...
    <form action="{{ route('folhas.storeall', $folha->id_folha_pagamento) }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <h6><span style="font-weight: bold; font-size: medium;">Local:</span>
                    {{ $folha->local ? $folha->local->descricao : 'Todos os locais / Não especificado' }} </h6>
                <p>
        ...
        <div>
                            ...
                            (function () {
                                ...
                                function updateValores() {
                                    ...
                                    if (tipoTaxa === 'fixa') {
                                        ...
                                        valorTaxa = (Number(taxaPercentual) / 100) * Number(bolsaMes);
                                    }
            ...
            <!-- Botão para salvar a folha de pagamento -->
            <div class="text-end mb-3">
                <button type="button" id="btn-salvar-folha" class="btn btn-primary">Salvar Folha de Pagamento</button>
            </div>
            ...
            <div id="modal-progresso"
                ...
                <div style="background: white; padding: 30px; border-radius: 10px; max-width: 500px; text-align: center;">
                    <h4>Salvando Folha de Pagamento</h4>
            ...
            <script>
                document.getElementById('btn-salvar-folha').addEventListener('click', async function () {
                    ...
                    try {
                        ...
                        texto.textContent = `Salvando ${totalRegistros} registros em ${totalLotes} lote(s)...`;
                        ...
                        detalhes.textContent = `${totalRegistros} registros salvos com sucesso`;
                        ...
                        console.error(error);
                        alert('Erro ao salvar a folha de pagamento: ' + error.message);
                        modal.style.display = 'none';
