    ...
    <div class="card mb-3 shadow-sm">
        <div class="card-body pb-2 pt-3">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    <a href="{{ route('supervisor.create') }}" class="btn btn-success btn-sm">
                        <i class="fas fa-plus me-1"></i> Adicionar Supervisor
                    </a>
                </div>
            </div>
            <form method="GET" action="{{ route('supervisores.index') }}">
                <div class="row align-items-end">
                    <div class="col-md-10">
                        ...
                        <div class="row g-2 mt-2">
                            <!-- Checkbox para ordenar pelos supervisores mais recentes -->
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2 d-flex flex-column align-items-end justify-content-end gap-2">
                                <a href="{{ route('supervisores.index') }}" class="btn btn-outline-secondary btn-sm w-100">
                ...
                @foreach ($supervisores as $supervisor)
                    <tr>
                        ...
                        <td style="width: 150px;;">
                            <a href="{{ route('supervisores.edit', $supervisor->id_supervisor) }}"
