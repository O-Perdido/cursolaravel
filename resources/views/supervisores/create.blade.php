...
<form action="{{ route($isEmpresa ? 'empresa.supervisores.store' : 'supervisor.store') }}" method="POST">
    @csrf
    <div class="row">
        <!-- Dados do Supervisor -->
        <div class="col-md-6">
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" class="form-control @error('cpf_supervisor') is-invalid @enderror"
                    id="cpf_supervisor" name="cpf_supervisor" value="{{ old('cpf_supervisor') }}" required>
