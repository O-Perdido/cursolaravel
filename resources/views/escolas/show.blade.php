            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p class="mb-1"><strong>CNPJ:</strong>
                        {{ $escola->numero_cnpj ? preg_replace('/(\d{2})(\d{3})(\d{3})(\d{4})(\d{2})/', '$1.$2.$3/$4-$5', $escola->numero_cnpj) : '' }}
                    </p>
                    <p class="mb-1"><strong>Telefone:</strong>
                        {{ $escola->numero_telefone ? preg_replace('/(\d{2})(\d{4,5})(\d{4})/', '($1) $2-$3', $escola->numero_telefone) : '' }}
                    </p>
                    <p class="mb-1"><strong>Celular:</strong>
                        {{ $escola->numero_celular ? preg_replace('/(\d{2})(\d{5})(\d{4})/', '($1) $2-$3', $escola->numero_celular) : '' }}
                    </p>
                    <p class="mb-1"><strong>Email:</strong> {{ $escola->email }}</p>
                    <hr class="my-2">
                    <h6 class="text-muted mb-3">Endereço</h6>
                    <p class="mb-1"><strong>CEP:</strong>
                        {{ $escola->numero_cep ? preg_replace('/(\d{5})(\d{3})/', '$1-$2', $escola->numero_cep) : '' }}</p>
                ...
                <div class="col-md-6">
                    ...
                    <p class="mb-1"><strong>CPF:</strong>
                        {{ $escola->cpf_representante ? preg_replace('/(\d{3})(\d{3})(\d{3})(\d{2})/', '$1.$2.$3-$4', $escola->cpf_representante) : '' }}
                    </p>
                    <p class="text-muted small">
                        <i class="fas fa-info-circle"></i> Use "Gerenciar Representantes" para cadastrar múltiplos
                            ...
                            <form action="{{ route('representantes.store') }}" method="POST">
                                ...
                                <div class="d-flex gap-2 mt-3">
                                    ...
                                    <button type="button" class="btn btn-secondary btn-sm"
                                        onclick="ocultarFormRepresentante()">
                                        Cancelar
                                    </button>
                                </div>
                            </form>
