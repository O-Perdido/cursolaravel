        ...
        <form method="POST" action="{{ route('vagas.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <label for="observacoes" class="form-label">OBS <small
                                class="text-muted">(opcional)</small></label>
                        <textarea name="observacoes" id="observacoes" class="form-control form-control-sm" rows="3"
                            placeholder="Anotações internas para orientar o preenchimento da vaga">{{ old('observacoes') }}</textarea>
                        <small class="form-text text-muted">Essas observações aparecem na geração do termo quando a vaga
                            for selecionada.</small>
                    </div>
                    ...
                    @if(in_array($nivel, ['empresa', 'admin', 'operador']))
                        ...
                        <div id="campos_estagiario" style="display:none;" class="border rounded p-3 mb-3">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="nome_social_estagiario" id="nome_social_estagiario"
                                    class="form-control form-control-sm" value="{{ old('nome_social_estagiario') }}"
