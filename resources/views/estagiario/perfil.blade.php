            ...
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="border rounded p-3 mb-3" style="background-color: #f8f9fa;">
                        ...
                        @if($estagiario->foto_documento)
                                     <a href="{{ route('estagiario.documento.download', ['campo' => 'foto_documento', 'cb' => time()]) }}" 
                    ...
                    <div class="border rounded p-3 mb-3" style="background-color: #f8f9fa;">
                        ...
                        @if($estagiario->comprovante_residencia)
                                     <a href="{{ route('estagiario.documento.download', ['campo' => 'comprovante_residencia', 'cb' => time()]) }}" 
                               class="btn btn-sm btn-outline-primary w-100 mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-download me-1" viewBox="0 0 16 16">
                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5"/>
                                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708z"/>
                    ...
                    <div class="border rounded p-3 mb-3" style="background-color: #f8f9fa;">
                        ...
                        @if($estagiario->comprovante_escolar)
                                     <a href="{{ route('estagiario.documento.download', ['campo' => 'comprovante_escolar', 'cb' => time()]) }}" 
                               class="btn btn-sm btn-outline-primary w-100 mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-download me-1" viewBox="0 0 16 16">
                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5"/>
                                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708z"/>
