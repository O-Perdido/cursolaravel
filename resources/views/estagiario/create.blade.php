...
@section('content')
    ...
    @if(session('success'))
        ...
        @endphp
        <form action="{{ route('estagiario.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback" id="pisError" style="display: none;">O PIS deve conter exatamente
                                    11 dígitos numéricos.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="chave_pix" name="chave_pix"
                                    value="{{ old('chave_pix', $estagiario->chave_pix ?? '') }}" required>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row" style="padding-top: 20px;">
                <div class="col-12">
                    <h4 class="mb-3">Documentos Necessários</h4>
                </div>
                <div class="col-md-4">
            ...
            <div class="row" style="padding-top: 20px;">
                <div class="col-12">
                    <h4 class="mb-3">Dados Acadêmicos</h4>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
        ...
        <script>
            ...
            function checarCamposValidos() {
                ...
                document.getElementById('cadastrarBtn').disabled = !cpfValido;
            }
